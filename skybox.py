...
class Skybox(object):
    def __init__(self, textureList, vertexShaders, fragmentShader):
        ...
        self.shaders = compileProgram(compileShader(vertexShaders, GL_VERTEX_SHADER), 
        ...
        for i in range(len(textureList)):
            texture = pg.image.load(textureList[i])
